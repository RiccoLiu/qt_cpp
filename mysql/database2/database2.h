...
public:
    static std::unique_ptr<Database2> Create(const MySqlConfig& config);
    static std::unique_ptr<Database2> Create(const SqliteConfig& config);
};
